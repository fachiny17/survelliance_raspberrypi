...
Please check the attachment sent from raspberry pi security system.
...
filepath = "/home/fachiny17/codex/pi/python_code/capture"
...
def capture_video():
    ...
    camera.start_recording('/home/fachiny17/codex/pi/python_code/capture/newvideo.h264')
    camera.wait_recording(20)
    camera.stop_recording()
    camera.stop_preview()

def remove_file():
    if os.path.exists("home/fachiny17/codex/pi/python_code/capture"):
        os.remove("home/fachiny17/codex/pi/python_code/capture")
    else:
...
while True:
    ...
    if i == 1:
        ...
        capture_video()
        sleep(2)
        res = os.system("MP4Box -add /home/fachiny17/codex/pi/python_code/capture/newvideo.h264 /home/fachiny17/codex/pi/python_code/capture/newvideo.mp4")
        os.system("mv /home/fachiny17/codex/pi/python_code/capture/newvideo.mp4 "+filepath+filename)
        send_email()
        sleep(2)
        remove_file()